...
if __name__ == "__main__":
    filter_option = input("What would you like to filter by? (Currently, only 'name', 'email' & 'age' are supported): ").strip().lower()
    ...
    if filter_option == "name":
        ...
        if not age_to_search.isdecimal():
            print('Argument: age must be decimal!')
